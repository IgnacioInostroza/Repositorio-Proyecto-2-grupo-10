...
for i in barras_a_rediseñar:
    ...
    seccion_1.append( barras[i].rediseñar(f_1[i]))


seccion_2=[]
barras = ret_L.obtener_barras()
barras_a_rediseñar = range(len(barras))
for i in barras_a_rediseñar:

    seccion_2.append( barras[i].rediseñar(f_2[i]))


radio_final=[]
for i in range(len(barras)):
    radio_final.append(max(seccion_1[i],seccion_2[i]))

for i in range(len(barras)):
    ret_D.barras[i].R=radio_final[i]
    ret_L.barras[i].R=radio_final[i]
...
peso2 = ret_D.calcular_peso_total()
